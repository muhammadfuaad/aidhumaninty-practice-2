    ...
    <div>
      <div className="flex flex-col bg-white rounded-3xl sm:pb-10">
        ...
        <div className="bg-[#bdbdbd] h-96 w-full flex justify-center items-center relative">
          ...
          <button className="px-20 py-6 uppercase text-[1.4rem] font-semibold text-headings bg-green rounded-xl absolute right-12 bottom-12">
            Change Cover
          </button>
        </div>
      ...
      <div className="flex flex-col bg-white rounded-3xl mt-8">
        <div className="p-12">
          ...
          <button className="w-full py-6 uppercase text-[1.4rem] font-semibold text-headings bg-green rounded-xl sm:hidden">
            Select From Gallery
          </button>
