      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex space-x-2">
          ...
          <div className="flex flex-col justify-center">
            <span className="text-[2rem] font-semibold text-headings">12</span>
            <span className="text-[1rem] font-semibold tracking-[-0.25px] text-headings">hours</span>
          </div>
          <span className="mb-6">&#58;</span>
          <div className="flex flex-col justify-center">
            <span className="text-[2rem] font-semibold text-headings">30</span>
            <span className="text-[1rem] font-semibold tracking-[-0.25px] text-headings">mins</span>
          </div>
        </div>        
      </div>
