  ...
  return (
    <table className="w-full bg-white">
      ...
      <tr className="text-[1.1rem] tracking-[-0.28px]">
        ...
        <td className="py-2 border-bottom-light"><span className="font-normal text-headings">Great Britain</span></td>
        <td className="flex space-x-2 items-center py-2 border-bottom-light">
          ...
          <span className="font-medium text-headings">Tue 12 Dec, 08:15</span>
        </td>
      ...
      <tr className="text-[1.1rem] tracking-[-0.28px]">
        ...
        <td className="py-2"><span className="font-normal text-headings">Great Britain</span></td>
