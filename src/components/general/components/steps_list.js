    ...
    <div>
      <div className="flex gap-20 items-center">
        <div className="flex gap-2 items-center">
          <div className="flex justify-center items-center h-16 w-16 rounded-full bg-[#e6e6e6]"><p className="text-[1.8rem] font-semibold tracking-[-0.45px] text-black">1.</p></div>
      ...
      <div className="flex gap-20 items-center">
        <div className="flex gap-2 items-center">
          <div className="flex justify-center items-center h-16 w-16 rounded-full bg-[#e6e6e6]"><p className="text-[1.8rem] font-semibold tracking-[-0.45px] text-black">2.</p></div>
          <img src={Icon_2}></img>
        </div>
      ...
      <div className="flex gap-20 items-center">
        <div className="flex gap-2 items-center">
          <div className="flex justify-center items-center h-16 w-16 rounded-full bg-[#e6e6e6]"><p className="text-[1.8rem] font-semibold tracking-[-0.45px] text-black">3.</p></div>
          <img src={Icon_3}></img>
        </div>
      ...
      <div className="flex gap-20 items-center">
        <div className="flex gap-2 items-center">
          <div className="flex justify-center items-center h-16 w-16 rounded-full bg-[#e6e6e6]"><p className="text-[1.8rem] font-semibold tracking-[-0.45px] text-black">4.</p></div>
          <img src={Icon_4}></img>
        </div>
      ...
      <div className="flex gap-20 items-center">
        <div className="flex gap-2 items-center">
          <div className="flex justify-center items-center h-16 w-16 rounded-full bg-[#e6e6e6]"><p className="text-[1.8rem] font-semibold tracking-[-0.45px] text-black">5.</p></div>
          <img src={Icon_5}></img>
        </div>
