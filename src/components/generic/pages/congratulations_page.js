    ...
    <section>
      ...
      <div className='bg-[#f9f9f9] pt-12 pb-20 sm:pb-52 px-8'>
        <div className='w-full sm:w-1/2 mx-auto bg-white p-8 sm:p-12 rounded-3xl'>
          <div className="h-72 w-72 rounded-full my-6 bg-[#999] flex justify-center items-center mx-auto bg-[url('assets/images/heart-hands-1.png')] bg-cover bg-center bg-no-repeat">
