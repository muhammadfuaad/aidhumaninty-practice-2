  ...
  return (
    <section>
      ...
      <div className="flex flex-col mb-44">
        ...
        <div className="flex gap-60 pr-12 mt-52">
          <div className="w-1/2"><img src="./images/child-watching.png"  className="rounded-r-3xl h-full"/></div>
        ...
        <div className="flex flex-col items-center mt-20">
          <div className="flex gap-16 items-center self-center mb-16">
          ...
          <div className="flex flex-col items-center ml-24">
            <button className="mb-8 self-center px-28 h-20 py-6 uppercase text-[1.4rem] font-semibold text-white bg-primary rounded-xl">
              Donate Now
            </button>
