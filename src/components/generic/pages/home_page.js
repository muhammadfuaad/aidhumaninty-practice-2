    ...
    <section className="overflow-hidden">
      ...
      <section class="flex bg-amber px-48 py-12">
        ...
        <div class="flex basis-[25%] items-center space-x-4">
          ...
          <p class="text-body text-base font-medium tracking-[-0.24px] leading-[20px]">Aid Humanity helps you make it happen…</p>
        </div>
      ...
      <section>
        <div class="flex flex-col space-y-8 bg-Ghost-white px-48 py-12">
          <p class="text-black text-3xl font-bold tracking-[-0.75px]">Latest News</p>
          <div class="flex">
            ...
            <div class="basis-[25%] flex-col">
              <div class="px-8 space-y-1">
                <p class="text-black text-lg font-bold tracking-[-0.45px]">Mauris vel ornare massa, at ullamcorper ligula</p>
            ...
            <div class="basis-[25%] flex-col">
              <div class="px-8 space-y-1">
                <p class="text-black text-lg font-bold tracking-[-0.45px]">Aenean ac iaculis urna, quis condimentum elit</p>
          ...
          <div class="flex justify-center items-center">
            <button class="w-[450px] text-primary-dark font-medium rounded-lg border-Gray border-2 border-opacity-50 py-2">View All</button>
          </div>
        </div>
      </section>
      
      <section>
        <div class="flex items-center h-[150px] space-y-2 bg-primary px-48">
      ...
      <section>
        <div class="flex px-48 py-12">
          <p class="basis-[30%] text-black text-3xl font-bold tracking-[-0.75px] pr-48">Passionate about progress</p>
          <p class="basis-[70%] text-body text-[22px] font-normal tracking-[-0.55px] pl-16 border-l border-opacity-25 border-Gray">We’ve always believed that charitable donations should find their way to the people
        ...
        <div class="flex px-48 pb-20 relative">
          ...
          <div class="flex flex-col bg-white w-[330px] h-[175px] px-16 py-8 border-amber border-2 rounded-lg absolute top-[10rem] left-[55rem]">
            <p class="text-center text-primary-dark text-lg font-normal tracking-[-0.45px]"><span class="text-black font-bold">Get Distributed Fairly</span> because never take a penny towards our running costs</p>
          </div>

          <div class="basis-[40%] flex flex-col pt-24 pl-48 space-y-12">
            <div class="flex flex-col bg-white w-[330px] h-[175px] px-16 py-8 border-primary border-2 rounded-lg relative">
              <p class="text-center text-primary-dark text-lg font-normal tracking-[-0.45px]"><span class="text-black font-bold">Make A Difference</span> to the people in the world who need you</p>
            </div>
            <div class="flex flex-col bg-white w-[330px] h-[175px] px-16 py-8 border-primary-dark border-2 rounded-lg relative">
              <p class="text-center text-primary-dark text-lg font-normal tracking-[-0.45px]"><span class="text-black font-bold">Be Spent Wisely</span> on projects that change lives and build communities</p>
            </div>
          </div>
        ...
        <div class="flex space-x-8 py-8">
          <div class="basis-[60%] space-y-8 flex flex-col pl-48 bg-white">
            <div class="flex flex-col mr-96 space-y-4">
              <p class="text-black text-3xl font-bold tracking-[-0.75px]">Ways to give</p>
              <p class="text-body text-[22px] font-normal tracking-[-0.55px]">Crowd funding lets people play a more important role in their charity.
            ...
            <div class="flex flex-col space-y-4 pr-44">
              <div class="flex items-center p-4 space-x-8  shadow-md border-Gray border-2 border-opacity-25 rounded-lg">
                <p class="text-primary-dark text-[38px] font-medium tracking-[-0.95px]">01.</p>
                <div class="flex flex-col space-y-2">
                  <p class="text-black text-lg font-bold tracking-[-0.45px]">You could make a quick one off donation</p>
              ...
              <div class="flex items-center p-4 space-x-8  shadow-md border-Gray border-2 border-opacity-25 rounded-lg">
                <p class="text-primary-dark text-[38px] font-medium tracking-[-0.95px]">02.</p>
                <div class="flex flex-col space-y-2">
                  <p class="text-black text-lg font-bold tracking-[-0.45px]">Subscription donation</p>
              ...
              <div class="flex items-center p-4 space-x-8  shadow-md border-Gray border-2 border-opacity-25 rounded-lg">
                <p class="text-primary-dark text-[38px] font-medium tracking-[-0.95px]">03.</p>
                <div class="flex flex-col space-y-2">
                  <p class="text-black text-lg font-bold tracking-[-0.45px]">Project Backed donation</p>
          ...
          <div class="basis-[40%] flex flex-col">
            <div class="flex flex-col space-y-4 pr-48">
              <p class="text-primary text-[36px] font-bold tracking-[-0.54px]">Don’t wait for the world to improve.</p>
              <p class="text-body text-[22px] font-normal tracking-[-0.55px]">Drive meaningful change.</p>
              <button class="w-[170px] h-[50px] text-primary border-2 border-primary rounded-lg">REGISTER NOW</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <div class="flex flex-col space-y-2 bg-amber px-48 py-12">
        <div class="flex flex-col px-[260px] space-y-12">
          <p class="text-black text-[30px] font-bold tracking-[-0.75px] leading-[34px]">Contact Us</p>
          <div class="flex justify-center space-x-12">
            <div class="flex flex-col space-y-12">
              <div class="flex flex-col space-y-4">
                <div class="flex flex-col space-y-4 bg-white border-black border-2 p-5 rounded-xl w-[330px] h-[140px]">
                  <div class="flex justify-between">
                    <div class="flex space-x-2 items-center">
                      <p class="text-black text-lg font-bold tracking-[-0.45px] leading-[24px]">Register</p>
                    </div>
                  </div>
                  <p class="text-body text-base font-normal tracking-[-0.4px] leading-[24px]">I want to help Aid Humanity and receive future appeals</p>
                </div>

                <div class="flex flex-col space-y-4 border-Gray border-opacity-25 border-2 p-5 rounded-xl w-[330px] h-[140px]">
                  <div class="flex justify-between">
                    <div class="flex space-x-2 items-center">
                      <p class="text-black text-lg font-bold tracking-[-0.45px] leading-[24px]">Fundraiser</p>
                    </div>
                  </div>
                  <p class="text-body text-base font-normal tracking-[-0.4px] leading-[24px]">Become a fundraiser and kick start your own Charity appeal</p>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col space-y-8">
              <div class="flex flex-col space-y-4 w-[540px]">
                <input class="placeholder-black text-[13px] font-normal tracking-[0px] leading-[15px] bg-amber border-2 border-opacity-50 border-black rounded-lg h-[50px] p-2" placeholder="Name and Surname*"></input>
                <input class="placeholder-black text-[13px] font-normal tracking-[0px] leading-[15px] bg-amber border-2 border-opacity-50 border-black rounded-lg h-[50px] p-2" placeholder="Email*"></input>
                <input class="placeholder:text-start placeholder:-translate-y-6 placeholder-black text-[13px] font-normal tracking-[0px] leading-[15px] bg-amber border-2 border-opacity-50 border-black rounded-lg h-[98px] p-2" placeholder="Please provide as much detailed information as possible. Thank you *"></input>
              </div>
