          ...
          <div className="flex flex-col sm:flex-row sm:justify-between">
            <div className="w-1/2 flex flex-col">
              <div className="flex flex-col gap-10">
                ...
                <p className="generic-sub-heading">Simplifying your Zakat calculation</p>
                ...
                <p className="generic-sub-heading">Using the Zakat calculator</p>
                ...
                <p className="generic-sub-heading">Zakat Scholar: Providing specialist advice</p>
                ...
                <p className="generic-sub-heading">What is Nisab?</p>
