      ...
      <div class="flex flex-col space-y-4 h-[70%]">
        <div class="flex justify-between">
          <div class="flex flex-col">
            <p class="text-primary-dark text-[11px] font-semibold tracking-[-0.17px] leading-[13px]"></p>
            <p class="text-primary text-[28px] font-semibold tracking-[-0.7px] leading-[32px]"></p>
          </div>
        </div>
        <p class="text-black text-base font-bold tracking-[-0.4px] leading-[20px]"></p>
      </div>
