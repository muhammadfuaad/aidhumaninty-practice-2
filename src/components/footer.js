      ...
      <div className="wrapper">
        ...
        <div className="flex gap-12">
          ...
          <div className="flex flex-col basis-[40%]">
            <div className="mr-12 ">
              <div className="flex">
                <img src={Footer_logo} className= "h-[7.4rem] w-[10.6rem]" alt= "footer logo" />
                <div className="ml-12 flex flex-col justify-between">
                  <div className="flex space-x-2 items-center">
                    <img src={Phone} className= "w-[17px] h-[1rem] mr-1" alt= "phone icon" />
                  ...
                  <div className="flex justify-between items-center w-[10.3rem]">
                    <img src={Facebook} className= "w-[9px] h-[1rem]" alt= "facebook icon" />
                    <img src={Twitter} className= "w-[20px] h-[17px]" alt= "twitter icon" />
                    <img src={Instagram} className= "w-[25px] h-[25px]" alt= "instagram icon" />
                    <img src={Linkedin} className= "w-[18px] h-[17px]" alt= "linkedin icon" />
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center mt-[4rem]">
              ...
              <img src={Regular} className= "w-[7.5rem] h-[2.25rem] mix-blend-luminosity" alt= "regulator icon" />
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center text-white mt-[6.8rem]">
              ...
              <img src={Percent} className= "w-[113px] h-[46px]" alt= "100percent" />
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <div className="flex justify-between items-center basis-[25%]">
            <img src={Visa} className= "w-[43px] h-[14px] mix-blend-luminosity" alt= "visa logo" />
            <img src={Mastercard} className= "w-[29px] h-[18px] mix-blend-luminosity" alt= "mastercard logo" />
            <img src={Paypal} className= "w-[87px] h-[21px] mix-blend-luminosity" alt= "paypal logo" />
            <img src={Stripe} className= "w-[53px] h-[22px] mix-blend-luminosity" alt= "stripe logo" />
          </div>
        </div>
      </div>
    </footer>
