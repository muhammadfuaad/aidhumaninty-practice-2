  ...
  return (
    <div className=" bg-[#f5f6f7] min-h-screen relative overflow-hidden">
      ...
      <ul className="text-[1.8rem] font-semibold tracking-[-0.27px] text-black">
        ...
        <li className="p-6 border-bottom-medium"><a href="#" className="flex justify-between"><span>Appeal</span><img src="./icons/arrow-right.svg"></img></a></li>
        <li className="p-6 border-bottom-medium"><a href="#" className="flex justify-between"><span>Emergency</span><img src="./icons/arrow-right.svg"></img></a></li>
        <li className="p-6 border-bottom-medium"><a href="#" className="flex justify-between"><span>Zakat</span><img src="./icons/arrow-right.svg"></img></a></li>
        <li className="p-6 border-bottom-medium"><a href="#" className="flex justify-between"><span>Get Involved</span><img src="./icons/arrow-right.svg"></img></a></li>

        <li className="p-6 border-bottom-medium"><a href="#">Zakat Calculator</a></li>
        <li className="p-6 border-bottom-medium"><a href="#">Blog</a></li>
        <li className="p-6 border-bottom-medium"><a href="#" className="flex gap-4 items-center"><img src="./icons/user-circle.svg" className="w-10"></img>My Account</a></li>
