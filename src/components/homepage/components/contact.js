        ...
        <div className="flex flex-col sm:flex-row sm:gap-28">
          <div className="flex flex-col space-y-12">
            <div className="flex flex-col gap-8">
              <div className="flex flex-col space-y-4 bg-white border-black border-2 p-5 rounded-3xl sm:w-[33rem] h-[140px]">
              ...
              <div className="flex flex-col space-y-4 border-gray border-opacity-25 border-2 p-5 rounded-3xl sm:w-[33rem] h-[140px]">
                <div className="flex justify-between">
                  <div className="flex space-x-2 items-center">
                    <img src={dot} className="w-8"></img>
